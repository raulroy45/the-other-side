...
public class Level5Tutorial : MonoBehaviour
{
    ...
    void Update() {
        ...
        if (triggerNo == 13 && Input.GetKeyDown(KeyCode.J)) {
            triggerNo++;
        }
        handleDialogues();
    }
